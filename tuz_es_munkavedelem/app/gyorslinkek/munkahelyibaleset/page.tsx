...
import {
  ArrowLeftIcon,
  ShieldExclamationIcon, // Fő ikon
  MagnifyingGlassCircleIcon, // Tényfeltárás
  ScaleIcon, // Jogi kötelezettség
  MapIcon, // Helyszíni szemle
  UserIcon, // Személyi sérülések
  ClipboardDocumentListIcon, // Adatgyűjtés
  LinkIcon, // Ok-okozati
  DocumentTextIcon, // Jegyzőkönyv
  ExclamationTriangleIcon, // Figyelmeztetés
  CalendarDaysIcon,
  WrenchScrewdriverIcon, // Szolgáltatások
  LifebuoyIcon,
  FolderOpenIcon,
  LightBulbIcon
          ...
          <main className="grid-bg p-8 sm:p-12 rounded-2xl shadow-2xl border border-slate-200/80">
            ...
            <section className="text-center border-b border-slate-200 pb-10 mb-10">
              ...
              <p className="text-lg text-slate-600 max-w-4xl mx-auto">
                A munkahelyi baleset olyan sérüléssel járó esemény, amely a munkavégzéssel összefüggésben, a munkavállalót éri. Ilyenkor a munkáltató első és legfontosabb feladata a sérült ellátásán túl a baleset szakszerű és jogszabályi előírásoknak megfelelő kivizsgálása. Ennek célja, hogy feltárja a baleset okait, megelőzze a hasonló esetek jövőbeli bekövetkezését, és megállapítsa a munkáltatói felelősséget.
              </p>
            </section>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
              ...
              <div className="lg:col-span-2 space-y-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div className="bg-white p-6 rounded-lg border border-slate-200 flex items-start gap-5">
                        ...
                        <div>
                            ...
                            <p className="text-slate-600 text-sm">Felderítjük a baleset pontos okait, legyen szó technikai, szervezési vagy emberi tényezőről, hogy elkerülhetővé váljanak a jövőbeni esetek.</p>
                        </div>
                    </div>
                    <div className="bg-white p-6 rounded-lg border border-slate-200 flex items-start gap-5">
                ...
                <section>
                  <h2 className="text-3xl font-bold text-slate-900 mb-6">Miből áll egy kivizsgálás?</h2>
              ...
              <aside className="space-y-10">
                <section>
                  ...
                  <div className={`p-6 rounded-lg border ${accentColor.warningBorder} ${accentColor.warningBg}`}>
                      <p className={`mb-4 ${accentColor.warningText}`}>
                          A munkahelyi balesetek bejelentését és kivizsgálását a <strong>munkavédelemről szóló 1993. évi XCIII. törvény</strong> és a <strong>33/1998. (VI. 24.) NM rendelet</strong> írja elő. A kivizsgálási eljárás határideje a baleset bejelentésétől számított 8 nap, súlyos baleset esetén pedig azonnal értesíteni kell a hatóságot.
                      </p>
                      <h4 className="font-bold text-lg mb-3 text-slate-800">A szakszerűtlen eljárás következményei:</h4>
                      <ul className="list-disc list-inside space-y-2 text-slate-700 text-sm">
                          <li><strong>Hatósági bírság:</strong> A munkavédelmi hatóság jelentős bírságot szabhat ki.</li>
                          <li><strong>Jogi felelősség:</strong> A munkáltatót polgári jogi és büntetőjogi felelősség is terhelheti.</li>
                          <li><strong>Kártérítési kötelezettség:</strong> A munkáltatónak a sérült felé kártérítési felelőssége van, ami jelentősen megnövekedhet.</li>
                      </ul>
                  </div>
                </section>
                ...
                <div className="sticky top-10 text-center p-8 bg-gradient-to-br from-cyan-500 to-teal-500 rounded-lg shadow-2xl">
                  ...
                  <p className="text-lg text-cyan-100 max-w-2xl mx-auto">
                    Ne bízza a véletlenre a balesetkivizsgálást. Keressen minket egy ingyenes konzultációért, és vegye igénybe szakértelmünket a szakszerű eljárás érdekében.
                  </p>
                  <div className="mt-8">
